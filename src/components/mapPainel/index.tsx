...
export default function MapPanel({ className = "", onSearch }: MapPanelProps) {
  ...
  return (
    <div
      id="map-panel"
      className={`absolute border-none left-2 sm:left-3 top-15  md:top-15 z-[1100]  sm:w-[300px] md:w-[360px] lg:w-[400px] max-w-[92vw] transition-all duration-200 ${className}`}
    >
